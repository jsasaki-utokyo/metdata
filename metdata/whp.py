...
class StationDict:
    '''
    Class to store station (str) and year (str or int) information in a dictionary.
    The dictionary is used to store hourly data or daily data for each station and year.
    Create an instance by whp_data = StationDict(), and access the instance by whp_data["Tokyo", 2021].
    '''
    def __init__(self):
        self.data = {}
...
class Whp(gwo.Hourly):
    ...
    def __init__(self, year, stn, dir_path='/mnt/d/dat/met/JMA_DataBase/whpView/wwwRoot/data/'):
        '''
        ...
        Parameters
        ----------
        dir_path(str): whpView data directory path, e.g., "/mnt/d/dat/met/JMA_DataBase/whpView/wwwRoot/data/"
